...
[`Sprint 3 - S3-05 technically validated; owner acceptance pending`](../ROADMAP.md)
...
S3-01 through S3-04 are owner accepted, while S3-05 is implemented and
technically validated and remains the only Active story pending owner
acceptance. S3-06 and broader runtime authorization remain unavailable.
