...
are owner accepted, and S2-04 is implemented and technically validated pending
...
treatment model and adapter, and exact fail-closed major-interface visibility
input awaiting later startup orchestration.
