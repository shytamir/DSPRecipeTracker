...
sufficiency, and machine-warning presentation model. The new model is not yet
connected to live runtime adapters or Unity rows. Installed and in-game
behavior remains unvalidated; no supported release exists.
